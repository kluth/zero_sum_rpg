# Zero Sum RPG Scenario: The Space Piracy

## Real-World Inspiration
This scenario is heavily anonymized but conceptually derived from current worldwide events regarding: **Hacking corporate supply shuttles returning from orbit**. It integrates modern digital demagogue mechanics and corporate overreach.

## 1. The Hook
The players are contracted to infiltrate a highly secure Spaceport Cargo Bay. An influential **Financial Guru** has weaponized their parasocial swarm of millions of followers to act as an unwitting shield for an illegal operation happening inside. The authorities will not intervene out of fear of a massive PR disaster and riots.
...
## 3. The Complication
Violence is not an option here. *Alternatively, the players can leverage Deep Cover to bypass the guard entirely by passing a DC 2 Subterfuge check.* **Zero-gravity environment; standard physics and combat rules don't apply.**
