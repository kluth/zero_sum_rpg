...
queries = {
    'chant_usa.mp3': 'usa chant',
    'chant_uk.mp3': 'england crowd',
    'chant_france.mp3': 'french protest',
    'crowd_protest.mp3': 'protest crowd',
    'crowd_riot.mp3': 'riot glass',
    'crowd_panic.mp3': 'crowd panic screaming'
}
...
for filename, query in queries.items():
    ...
    try:
        req = urllib.request.Request(url, headers={'User-Agent': 'ZeroSumBot/5.0'})
        ...
        if docs:
            ...
            with urllib.request.urlopen(urllib.request.Request(files_url, headers={'User-Agent': 'ZeroSumBot/5.0'})) as f_resp:
                ...
                if mp3_file:
                    ...
                    with urllib.request.urlopen(urllib.request.Request(download_url, headers={'User-Agent': 'ZeroSumBot/5.0'})) as audio_req:
