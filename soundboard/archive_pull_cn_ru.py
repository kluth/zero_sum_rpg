...
queries = {
    'chant_china.mp3': 'china protest',
    'chant_russia.mp3': 'russia protest'
}
...
for filename, query in queries.items():
    ...
    try:
        req = urllib.request.Request(url, headers={'User-Agent': 'ZeroSumBot/6.0'})
        ...
        if docs:
            ...
            with urllib.request.urlopen(urllib.request.Request(files_url, headers={'User-Agent': 'ZeroSumBot/6.0'})) as f_resp:
                ...
                if mp3_file:
                    ...
                    with urllib.request.urlopen(urllib.request.Request(download_url, headers={'User-Agent': 'ZeroSumBot/6.0'})) as audio_req:
