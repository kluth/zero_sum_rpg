...
const AcousticPhysics_1 = require("../../src/psychophysics/AcousticPhysics");
describe('Psychophysics: Acoustic & Stress Models', () => {
    describe('calculateSNR', () => {
        it('should correctly calculate SNR using Inverse Square Law', () => {
            ...
            // SNR = 120 - 40 = 80
            const result = (0, AcousticPhysics_1.calculateSNR)({
                sourceDb: 140,
                distanceMeters: 10,
                ambientDb: 40
            });
        ...
        it('should return failure if distance is <= 0', () => {
            const result = (0, AcousticPhysics_1.calculateSNR)({ sourceDb: 100, distanceMeters: 0, ambientDb: 40 });
    ...
    describe('checkCyberpsychosis', () => {
        it('should trigger Haptic Feedback Signal when stress crosses 75', () => {
            const result = (0, AcousticPhysics_1.checkCyberpsychosis)({ currentStress: 76 });
            expect(result.isSuccess()).toBe(true);
            if (result.isSuccess()) {
        ...
        it('should remain stable when stress is <= 75', () => {
            const result = (0, AcousticPhysics_1.checkCyberpsychosis)({ currentStress: 70 });
            expect(result.isSuccess()).toBe(true);
            if (result.isSuccess()) {
...
//# sourceMappingURL=AcousticPhysics.spec.js.map